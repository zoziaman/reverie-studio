...
passing `public_snapshot` from a clean workspace. The publish set must have no
real secrets, no personal data, no local runtime state, and no generated or
